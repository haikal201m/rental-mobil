...
<li id="output"></li>
   <?php
   		if (isset($_SESSION['pb'])) {
			...
			$name=array("","Tambah Pelanggan","Daftar Pelanggan","Konfirmasi","Lihat konfirmasi","Catatan","Lihat Catatan","Ubah Katasandi", "Keluar");
			...
			$name=array("","Konfirmasi","Konfirmasi Saya","Tambah Catatan","Catatan","Keluar");
