<h3 class='page-header'>Daftar Pelanggan</h3>
<?php 
if (isset($_GET['st'])) {
        if ($_GET['st']==1) {
            ...
            echo "<table class='table table-striped' style='width:70%'>
                    ...
                    while ($get_siswa = $query_siswa->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td><a href='siswa&id_siswa=$id_siswa' title='Edit $name'>Edit info</a> &bullet; <a style='cursor:pointer' onclick='hapusSiswa($id_siswa)' >Hapus Pelanggan</a></td>
                            </tr>";
                    }
                   // $conn->close();
                    echo "</tbody></table>";
...
<script src="lib/js/sweetalert2.min.js"></script> <link rel="stylesheet" type="text/css" href="lib/js/sweetalert2.css">
    <script>
        function hapusSiswa(id_siswa) {
            ...
            swal({
                title: 'Anda Yakin?',
                text: 'Semua data Pelanggan akan dihapus!',type: 'warning',
